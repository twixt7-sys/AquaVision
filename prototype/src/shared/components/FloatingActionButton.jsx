...
import { Plus, Droplets, UtensilsCrossed, Stethoscope, MessageCircle, X } from 'lucide-react';
...
const ACTIONS = [
  { icon: Droplets, label: 'Log reading', path: '/demo/free/water', className: 'bg-sky-600 hover:bg-sky-700' },
  { icon: UtensilsCrossed, label: 'Log feeding', path: '/demo/free/feeding', className: 'bg-amber-600 hover:bg-amber-700' },
  { icon: Stethoscope, label: 'Disease ID', path: '/demo/free/disease', className: 'bg-rose-600 hover:bg-rose-700' },
  { icon: MessageCircle, label: 'Ask assistant', path: '/demo/free/assistant', className: 'bg-primary hover:bg-primary/90' },
];
            ...
            {ACTIONS.map((action, i) => {
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    'flex items-center gap-2 rounded-full py-2 pl-3 pr-4 text-sm font-medium text-white shadow-md',
                    action.className,
                  )}
                >
                  <Icon size={16} />
