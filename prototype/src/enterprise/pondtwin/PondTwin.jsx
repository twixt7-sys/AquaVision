...
// exist yet; REQ-TWIN-006). Top-down map + vertical slice + time scrub, with
// confidence-based uncertainty rendering as the core honesty feature.
    ...
    <div className="stack" style={{ gap: 16 }}>
      <div className="row wrap" style={{ justifyContent: 'space-between', gap: 8 }}>
        <div>
          ...
          <p className="muted" style={{ margin: 0, fontSize: 'var(--fs-sm)' }}>
            3D visualisation with a twin roadmap — the simulation core does not exist yet.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.4fr) minmax(0, 1fr)', gap: 16, alignItems: 'start' }}>
        <div className="stack" style={{ gap: 10 }}>
          <div className="section-title">Top-down · surface field</div>
